      ...
      <Form onSubmit={handleSubmit}>
        ...
        <RowDiv>
          <SelectBox
            ...
            id="asr_organization"
            label="Organization"
            name="asr_organization"
            placeholder="Location"
            onInputChange={setFieldValue}
            onBlur={handleBlur}
            errorMessage={errors.asr_organization}
            value={values.asr_organization}
            width={630}
            touched={touched.asr_organization}
            options={organizationsOptionsData}
            disabled={isSubmitting}
          />
        </RowDiv>
