...
function EditAssetsValue({
  ...
  let initialValues = {
    asv_name: selectedAssetValue?.asv_name || '',
    asv_value: selectedAssetValue?.asv_value || null,
  };
...
export default EditAssetsValue;
