...
function EditAssetsSubGroup({
  onCloseDrawer,
  selectedOperatingSystemData,
  editOperatingSystem,
  isVisible
}) {

  let initialValues = {
    aos_os_name: selectedOperatingSystemData?.aos_os_name || '',
    aos_os_version: selectedOperatingSystemData?.aos_os_version || null,
  };
